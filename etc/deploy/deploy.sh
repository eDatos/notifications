...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-notifications-web/target/notices-internal-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/notices-internal.war
